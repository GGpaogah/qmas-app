        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('profile.userprofile') }}">
                        <i class="fas fa-user"></i><span>Akun</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('superadmin.manage-users.index') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('superadmin.stok.create') }}">
                        <i class="fa-solid fa-inbox-in"></i><span>Tambah Data Stok Masuk</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('superadmin.stok.out') }}">
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in">
                                    <a class="dropdown-item" href="{{ route('profile.userprofile') }}"><i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Akun</a>
                        ...
                        <div class="card shadow">
                            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                <h6 class="m-0 font-weight-bold text-primary">
                                    @if (request('gudang')) Input Stok Keluar Gudang {{ ucfirst(request('gudang')) }}
                                    @else
                                    Input Stok Keluar
                                    @endif
                                </h6>
                                <!-- Form with GET Method to select Gudang -->
                                <form method="GET" action="{{ route('superadmin.stok.out') }}">
                                    <select class="form-select" name="gudang" id="gudang" onchange="this.form.submit()" required>
                            ...
                            <div class="card-body">
                                @if (request('gudang'))
                                <form method="POST" action="{{ route('superadmin.stok.keluar') }}">
                                    @csrf
                                ...
                                @else
                                <p class="text-center">Tidak dapat input data stok keluar sekarang, silakan pilih gudang terlebih dahulu.</p>
                                @endif
                            </div>
                        </div>
                    </div>
