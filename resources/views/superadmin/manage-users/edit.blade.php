<!-- resources/views/superadmin/manage-users/edit.blade.php -->
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row d-xl-flex justify-content-xl-start">
                        <div class="col-lg-4 d-lg-flex flex-fill justify-content-xl-start align-items-xl-center">
                            <h2 class="d-lg-flex" style="padding: 10px;width: 300px;">Edit Akun</h2>
                        </div>
                    </div>
                    ...
                    <div class="card shadow">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h6 class="text-primary fw-bold m-0">Form Edit Akun</h6>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <form action="{{ route('superadmin.manage-users.update', $user->id) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="mb-3">
        ...
        <input type="password" class="form-control" placeholder="(Kosongkan jika tidak diubah)" id="password" name="password">
    </div>
