...
<head>
    ...
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i&display=swap">
        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('admin/stok-masuk') ? 'active' : '' }}"
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown"
                                    href="#">
                                    <span class="d-none d-lg-inline me-2 text-gray-600 small">{{ Auth::user()->name
                                        }}</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">
                            Stok Masuk Gudang {{ ucfirst($gudang) }}
                        </h6>
                            <form method="GET" action="{{ route('admin.stok.index') }}">
                                <div class="d-flex">
                                    <!-- Tipe Produk Filter -->
                                    <select class="form-select me-2" name="tipe_produk" id="tipe_produk"
                                        onchange="this.form.submit()">
                                        <option value="">Semua Produk</option>
                                        <option value="120 ml" {{ request('tipe_produk') == '120 ml' ? 'selected' : ''
                                            }}>120 ml</option>
                                        <option value="240 ml" {{ request('tipe_produk') == '240 ml' ? 'selected' : ''
                                            }}>240 ml</option>
                                        <option value="330 ml" {{ request('tipe_produk') == '330 ml' ? 'selected' : ''
                                            }}>330 ml</option>
                                        <option value="600 ml" {{ request('tipe_produk') == '600 ml' ? 'selected' : ''
                                            }}>600 ml</option>
                                        <option value="1500 ml" {{ request('tipe_produk') == '1500 ml' ? 'selected' :
                                            '' }}>1500 ml</option>
                                        <option value="Galon Refill" {{ request('tipe_produk') == 'Galon Refill' ?
                                            'selected' : '' }}>Galon Refill</option>
                                        <option value="Galon Perdana" {{ request('tipe_produk') == 'Galon Perdana' ?
                                            'selected' : '' }}>Galon Perdana</option>
                                    </select>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            @else
                            <p class="text-center">Tidak ada data yang tersedia untuk stok masuk.</p>
                            @endif
                        </div>
                    </div>
                </div>
